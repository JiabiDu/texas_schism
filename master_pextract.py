...
sinputs=(
  (1,['elevation'],'station_noaa_wl_v4.bp','wl'), #wl
  (1,['sigWaveHeight','peakPeriod','dominantDirection'],'station_wave.bp','wave'), #wave
  (1,['horizontalVelX','horizontalVelY'],'station_current.bp','current2'), #current2
  (1,['salinity'],'station_salt.bp','salt'), #salt
  (1,['salinity'],'station_CB2.bp','salt2'), #salt2
  (1,['sedConcentration_1','sedConcentration_2','sedConcentration_3','sedConcentration_4',
    'sedBedStress','sedBedThickness','sedBedRoughness','sedErosionalFlux','sedDepositionalFlux',
    'sedBedFraction_1','sedBedFraction_2','sedBedFraction_3','sedBedFraction_4',
    'sigWaveHeight'],'station_CB2.bp','sed'), #sed
  (1,['sedConcentration_1','sedConcentration_2','sedConcentration_3','sedConcentration_4',
    'sedBedStress','sedErosionalFlux','sedDepositionalFlux','sigWaveHeight'],
    'center_v3_vertical.bp','ssed'), #sed2
)
sinputs=[
  (1,1,['salinity',],'stations/station_twdb_salinity.bp','salt2'), #wl
  (1,0,['salinity',],'stations/station_tse.bp','salt'), #wl
  (0,0,['horizontalVelX','horizontalVelY'],'stations/station_noaa_current.bp','current'),
  (0,0,['elevation',],'stations/station_noaa_wl.bp','elevation'),
...
#resource requst 
walltime='02:00:00' 
qnode='grace'; nnode=2; ppn=20; mem='16G'
